...
public final class DeltaClass extends PersistentClass implements TableOwner {
	private PersistentClass superclass;
	private final int subclassId;
	private Table table;

	public DeltaClass(PersistentClass superclass, MetadataBuildingContext buildingContext) {
