...
public class EntityBinder {
	...
	public static void bindEntityClass(
		...
		System.out.println("bindEntityClassAnnotateBefore: " + clazzToProcess.getName() + " " + clazzToProcess.hasDirectAnnotationUsage( Delta.class ));
		System.out.println("InheritanceStates: " + inheritanceStates);
		...
		System.out.println("inheritanceState: " + inheritanceState + " " + inheritanceState.getClassDetails());
		System.out.println("bindEntityClass: " + clazzToProcess.hasDirectAnnotationUsage( Delta.class ));
...
//			discriminatorColumn.setPropertyHolder( holder );
	...
	private static PersistentClass makePersistentClass(
		...
		else if (inheritanceState.isDelta()) {
			return new DeltaClass(superEntity, metadataBuildingContext );
		}
		else {
